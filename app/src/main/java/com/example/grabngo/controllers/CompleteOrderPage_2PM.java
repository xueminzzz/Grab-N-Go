...
public class CompleteOrderPage_2PM extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complete_order_page_2pm);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(CompleteOrderPage_2PM.this, OrdersforSpecifiedTimePage1_2PM.class);
                startActivity(back);
            }
        });
        ...
        completeOrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CompleteOrderPage_2PM.this, OrdersforSpecifiedTimePage1_2PM.class);
                startActivity(i);
