...
public class OrdersforSpecifiedTimePage1_1PM extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.orders_for_specified_time_page_1_1pm);
...
//        mOrderList = (LinearLayout) findViewById(R.id.OrdersforSpecifiedTimePage1);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(OrdersforSpecifiedTimePage1_1PM.this, VendorMainPage.class);
                startActivity(back);
            }
        });
                        ...
                        if(stall_name.equals("Chicken Rice")){
                            ...
                            if (isCompleted) {
                                ...
                                orderCardView.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(OrdersforSpecifiedTimePage1_1PM.this, CompleteOrderPage_1PM.class);
