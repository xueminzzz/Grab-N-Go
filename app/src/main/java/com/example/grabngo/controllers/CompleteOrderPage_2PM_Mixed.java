...
public class CompleteOrderPage_2PM_Mixed extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complete_order_page_2pm_mixed);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(CompleteOrderPage_2PM_Mixed.this, OrdersforSpecifiedTimePage1_2PM_Mixed.class);
                startActivity(back);
            }
        });
        ...
        completeOrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CompleteOrderPage_2PM_Mixed.this, OrdersforSpecifiedTimePage1_2PM_Mixed.class);
                startActivity(i);
