...
//        mOrderList = (LinearLayout) findViewById(R.id.OrdersforSpecifiedTimePage1);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(OrdersforSpecifiedTimePage1_2PM.this, VendorMainPage.class);
                startActivity(back);
            }
        });
                        ...
                        if(stall_name.equals("Chicken Rice")){
                            ...
                            if (isCompleted) {
                                ...
                                orderCardView.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(OrdersforSpecifiedTimePage1_2PM.this, CompleteOrderPage_2PM.class);
