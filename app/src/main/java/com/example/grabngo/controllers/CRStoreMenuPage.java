...
/** Function: For users to view Chicken Rice stall's menu
 *  Input: Order singleton instance (setContentView to layout/cr_store_menu_page.xml)
...
public class CRStoreMenuPage extends Activity implements View.OnClickListener {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cr_store_menu_page);
