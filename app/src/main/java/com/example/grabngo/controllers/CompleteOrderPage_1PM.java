...
public class CompleteOrderPage_1PM extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complete_order_page_1pm);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(CompleteOrderPage_1PM.this, OrdersforSpecifiedTimePage1_1PM.class);
                startActivity(back);
            }
        });
        ...
        completeOrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CompleteOrderPage_1PM.this, OrdersforSpecifiedTimePage1_1PM.class);
                startActivity(i);
