...
public class OrdersforSpecifiedTimePage1_130PM_Mixed extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.orders_for_specified_time_page_1_130pm_mixed);
...
//        mOrderList = (LinearLayout) findViewById(R.id.OrdersforSpecifiedTimePage1);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(OrdersforSpecifiedTimePage1_130PM_Mixed.this, VendorMainPage_Mixed.class);
                startActivity(back);
            }
        });
                        ...
                        if(stall_name.equals("Noodles")){
                            ...
                            if (isCompleted) {
                                ...
                                orderCardView.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(OrdersforSpecifiedTimePage1_130PM_Mixed.this, CompleteOrderPage_130PM_Mixed.class);
